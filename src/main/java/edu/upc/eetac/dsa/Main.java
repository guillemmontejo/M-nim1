...
public class Main {
    ...
    public static HttpServer startServer() {
        ...
        beanConfig.setContact("guillem.montejo@estudiantat.upc.edu");
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println(String.format("RestApi Started at " + "%s", swagger_uri));
        String target = "minim1";
        String replacement = "swagger";
        swagger_uri = swagger_uri.replace(target, replacement);
        System.out.println(String.format("Swagger link %s", swagger_uri));
        System.out.println(String.format("Hit enter to stop the RestApi..."));
        System.in.read();
        server.shutdownNow();
    }
}
